                ...
                <tbody>
                  {logFiles.length === 0 ? (
                    ...
                    logFiles.map((file, index) => (
                      ...
                      >
                        <td style={{ padding: '12px 16px', border: '1px solid #eee' }}>{file.userId}</td>
                        <td style={{ padding: '12px 16px', border: '1px solid #eee' }}>{file.userEmail}</td>
                        <td style={{ padding: '12px 16px', border: '1px solid #eee' }}>{file.userFullName}</td>
                        <td style={{ padding: '12px 16px', border: '1px solid #eee' }}>{file.fileName}</td>
                        <td style={{ padding: '12px 16px', border: '1px solid #eee' }}>{formatFileSize(file.size)}</td>
                        <td style={{ padding: '12px 16px', border: '1px solid #eee' }}>
